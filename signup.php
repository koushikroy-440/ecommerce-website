          ...
          <div class="col-md-6">
            <form class="signup-form">
              <div class="form-group">
                ...
                <input type="text" class="form-control bg-light" placeholder="First Name" id="first_name">
              </div>

              <div class="form-group">
                <label for="last_name">Last Name<sup class="text-danger">*</sup></label>
                <input type="text" class="form-control bg-light" placeholder="last Name" id="last_name">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control bg-light" placeholder="*****89890" id="mobile">
              </div>
